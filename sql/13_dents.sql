-- ============================================================
-- 13_dents.sql — Karosserieschaden aus mDentSeverity + Reifen-platt.
-- Front-/Heckschaden getrennt (0=keiner..2=schwer), abgerissenes Teil,
-- flat je Rad (binaer aus mFlat). Nach 01-12 ausfuehren.
-- Idempotent: gefahrlos mehrfach ausfuehrbar, Daten bleiben erhalten.
-- ============================================================

-- 1) Spalten in stint_telemetry
